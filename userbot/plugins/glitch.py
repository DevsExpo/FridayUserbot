...
DURATION = 600  # Set this to however many centiseconds each frame should be visible for
LOOP = 2  # Set this to how many times the gif should loop
...
async def glitch(event):
    ...
    okbruh = await event.edit("`Glitching...`")
    if isinstance(sed.media, MessageMediaPhoto):
        ...
        return
    fmt = "gif"
    pathsn = f"./starkgangz/cipherx.{fmt}"
