...
USER_BOT_WARN_ZERO = "You Have Attempted To Spam My Masters Inbox So In Order To Avoid Over-Spam, You Have Been Blocked.."
USER_BOT_NO_WARN = (
    ...
    "**So Send** `/start` **, Register A Request And Wait For My Masters Approval..** \n\n"
    f"**{CUSTOM_MIDDLE_PMP}**"
)
