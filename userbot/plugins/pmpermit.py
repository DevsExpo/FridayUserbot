...
CUSTOM_MIDDLE_PMP = (
    str(CUSTOM_PMPERMIT) if CUSTOM_PMPERMIT else "**Don't Spam Otherwise Get Ready To Be F*&#ed..**"
)
...
USER_BOT_NO_WARN = (
    ...
    "**So Send** `/start` **, Register A Request And Wait For My Master's Approval..** \n\n"
    f"**{CUSTOM_MIDDLE_PMP}**"
)
