...
from uniborg.util import edit_or_reply, friday_friday_friday_sudo_cmd, friday_on_cmd
...
@friday.on(friday_friday_friday_sudo_cmd(pattern="autoname", allow_sudo=True))
async def _(event):
