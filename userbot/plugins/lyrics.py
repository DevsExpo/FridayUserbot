# Lel, Didn't Get Time To Make New One So Used Plugin Made by @Hackintush dont edit credits
import io
import os
...
async def lyrics(lyric):
    ...
    if GENIUS is None:
        ...
        try:
            ...
            await lyric.edit("`Lol please provide artist and song names`")
            return
...
CMD_HELP.update(
    ...
    \n USAGE: searches a song lyrics and sends you if song name doesnt work try along with artist name"
