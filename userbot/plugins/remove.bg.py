...
async def _(event):
    ...
    if "image" in contentType:
        with io.BytesIO(output_file_name.content) as remove_bg_image:
            remove_bg_image.name = "CipherX.png"
        ...
        await event.edit("Removed dat annoying Backgroup in {} seconds, powered by CipherX".format(ms))
    else:
        await event.edit("ReMove.BG API returned Errors. Please report to CipherX\n`{}".format(output_file_name.content.decode("UTF-8")))
